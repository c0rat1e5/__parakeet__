#!/usr/bin/env python3
"""
🦜 Nemotron Speech 0.6B-en Web UI
English Speech-to-Text Tool (WSL2 Compatible)

* Uses CTC decoder for WSL2 compatibility (avoids CUDA Graphs)
  See WSL2_CUDA_ERROR_README.md for details
"""
...
MODEL_PATH = SCRIPT_DIR / "nemotron-speech-streaming-en-0.6b.nemo"
...
# Gradio UI
# ========================================
with gr.Blocks(title="🦜 Nemotron English Speech-to-Text") as demo:
    
    gr.Markdown("""
    # 🦜 Nemotron Speech 0.6B-en
    ## English Speech-to-Text Tool
    """)
...
if __name__ == "__main__":
    print("=" * 60)
    print("🦜 Nemotron English Speech-to-Text Web UI")
    print("=" * 60)
